...
This section showcases \verb`\strips[options]` macro, where \texttt{options} should be one of:
\begin{itemize}
...
\strips[]
\subsection{Propositional, negative-preconditions}
\strips[negative-preconditions]
\subsection{Propositional, disjunctive-preconditions}
\strips[disjunctive-preconditions]
\subsection{Propositional, conditional-effects}
\strips[conditional-effects]
\subsection{Propositional, conditional-effects, negative-preconditions}
\strips[conditional-effects,negative-preconditions]
\subsection{Propositional, conditional-effects, disjunctive-preconditions}
\strips[conditional-effects,disjunctive-preconditions]
\subsection{Propositional, action-costs}
\strips[action-costs,]
\subsection{Propositional, action-costs, negative-preconditions}
\strips[action-costs,negative-preconditions]
\subsection{Propositional, action-costs, disjunctive-preconditions}
\strips[action-costs,disjunctive-preconditions]
\subsection{Propositional, action-costs, conditional-effects}
\strips[action-costs,conditional-effects]
\subsection{Propositional, action-costs, conditional-effects, negative-preconditions}
\strips[action-costs,conditional-effects,negative-preconditions]
\subsection{Propositional, action-costs, conditional-effects, disjunctive-preconditions}
\strips[action-costs,conditional-effects,disjunctive-preconditions]
\subsection{Propositional, derived-predicates}
\strips[derived-predicates]
\subsection{Propositional, derived-predicates, negative-preconditions}
\strips[derived-predicates,negative-preconditions]
\subsection{Propositional, derived-predicates, disjunctive-preconditions}
\strips[derived-predicates,disjunctive-preconditions]
\subsection{Propositional, derived-predicates, conditional-effects}
\strips[derived-predicates,conditional-effects]
\subsection{Propositional, derived-predicates, conditional-effects, negative-preconditions}
\strips[derived-predicates,conditional-effects,negative-preconditions]
\subsection{Propositional, derived-predicates, conditional-effects, disjunctive-preconditions}
\strips[derived-predicates,conditional-effects,disjunctive-preconditions]
\subsection{Propositional, derived-predicates, action-costs}
\strips[derived-predicates,action-costs,]
\subsection{Propositional, derived-predicates, action-costs, negative-preconditions}
\strips[derived-predicates,action-costs,negative-preconditions]
\subsection{Propositional, derived-predicates, action-costs, disjunctive-preconditions}
\strips[derived-predicates,action-costs,disjunctive-preconditions]
\subsection{Propositional, derived-predicates, action-costs, conditional-effects}
\strips[derived-predicates,action-costs,conditional-effects]
\subsection{Propositional, derived-predicates, action-costs, conditional-effects, negative-preconditions}
\strips[derived-predicates,action-costs,conditional-effects,negative-preconditions]
\subsection{Propositional, derived-predicates, action-costs, conditional-effects, disjunctive-preconditions}
\strips[derived-predicates,action-costs,conditional-effects,disjunctive-preconditions]
